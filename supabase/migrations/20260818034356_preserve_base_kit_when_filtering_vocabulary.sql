-- La migracion anterior filtro vocabulario sobre una version antigua de la
-- publicacion. Esta definicion parte de la version que repone el kit base y
-- limita el cambio a excluir propuestas que no pasaron el matcher.
