...
-- El resumen compuesto dejo de ser solo de precio: se usa en cualquier pregunta
-- cuyas opciones traigan su dato distintivo, y solo cuando el nivel no tiene
-- respuesta propia. El texto sembrado hablaba de precios; se generaliza sin
-- pisar una redaccion que alguien haya personalizado.
UPDATE public.bot_config
SET config_value = 'Esto es lo que hay: {opciones}.'
WHERE config_key = 'scope_catalog_summary_message'
  AND config_value = 'Precios disponibles: {opciones}.';
